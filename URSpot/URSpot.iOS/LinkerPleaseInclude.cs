...
namespace URSpot.iOS
{
	...
	public class LinkerPleaseInclude
	{
        ...
        public void Include(MvvmCross.Forms.Presenter.iOS.MvxFormsIosPagePresenter injector)
        {
            injector = new MvvmCross.Forms.Presenter.iOS.MvxFormsIosPagePresenter(null, null);
        }
